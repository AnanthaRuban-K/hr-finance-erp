  ...
  return (
    ...
    >
      <div className="flex h-10 items-center px-4 lg:px-6">
        {/* Mobile menu button */}
        <Button
          className="lg:hidden hover:bg-accent/50 h-8 w-8 p-0 border-0 bg-transparent"
        ...
        <div className="flex items-center space-x-4">
          <div className="hidden lg:flex lg:items-center lg:space-x-2">
            ...
            <span className="font-semibold text-base text-foreground">HR System</span>
          </div>
          {/* Mobile logo */}
        ...
        <div className="flex items-center space-x-2">
          {/* Notifications */}
          <Button 
            className="h-8 w-8 hover:bg-accent/50 relative p-0 border-0 bg-transparent"
          >
