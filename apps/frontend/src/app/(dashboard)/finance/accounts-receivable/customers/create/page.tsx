...
export default function CustomerForm() {
  ...
  const [formData, setFormData] = useState<CustomerFormData>(
    isEditMode ? existingCustomerData : initialFormData
  );
    ...
    <RoleGuard allowedRoles={[UserRole.FINANCE_MANAGER, UserRole.ADMIN]}>
      <div className="space-y-6">
        <PageHeader
          ...
          description={isEditMode ? `Update ${formData.company} information` : "Add a new customer to your accounts receivable"}
        >
          ...
          <div className="grid gap-6 lg:grid-cols-3">
            ...
            <Card className="lg:col-span-1">
              <CardHeader>
                ...
                <CardDescription>Upload a profile picture for the customer</CardDescription>
              </CardHeader>
